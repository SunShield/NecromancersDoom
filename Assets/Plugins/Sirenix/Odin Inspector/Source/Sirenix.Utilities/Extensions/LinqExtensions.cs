...
#pragma warning disable
    ...
    public static class LinqExtensions
    {
        ...
        /// </summary>
        public static HashSet<T> ConvertToHashSet<T>(this IEnumerable<T> source)
        {
        ...
        /// Convert a colletion to a HashSet.
        /// </summary>
        public static HashSet<T> ConvertToHashSet<T>(this IEnumerable<T> source, IEqualityComparer<T> comparer)
        {
